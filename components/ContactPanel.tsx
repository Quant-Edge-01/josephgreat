...
/**
 * The panel behind the project-page CTAs, split out of ContactProvider so it
 ...
 * having just read a case study. It leads with the free offer now and sends
 * people to the form, with the handle and address left as a fallback.
 *
 * Focus is trapped while open and returned to whatever opened it — a dialog
 * that drops focus back to the top of the document makes a keyboard user
